...
function bannerOn() {
  ...
  function render() {
    ulItem.insertAdjacentHTML('afterend',
  ...
  document.querySelector('.dice').addEventListener('click', () => { setTimeout((makeRandom()), 500) });


  function showAD() {
    bannerBox.insertAdjacentHTML('afterbegin', ' <div class="wrapper-ad-place"><span class="ad-place"> МЕСТО <br> ДЛЯ ВАШЕЙ <br> РЕКЛАМЫ </span></div>'
    )
  }

  function icecream() {
    bannerBox.insertAdjacentHTML('afterbegin',
